...
Your project uses Spring 3.2.4.RELEASE, but something else you're depending on
...
module, at its own `project.version`. So, `spring-version` `3.2.4.RELEASE`
will result in any Spring transitive dependency being imported at
`3.2.4.RELEASE`. Done, finished and klaar!
